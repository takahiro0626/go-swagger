...
func (o *PutUsersUserIDParams) WithUser(user *models.MainUpdateUserRequest) *PutUsersUserIDParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the put users user ID params
func (o *PutUsersUserIDParams) SetUser(user *models.MainUpdateUserRequest) {
	o.User = user
}
