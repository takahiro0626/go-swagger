...
type PostUsersParams struct {
	...
	/* User.
	   ...
	   user
	*/
	User *models.MainCreateUserRequest
...
func (o *PostUsersParams) WithUser(user *models.MainCreateUserRequest) *PostUsersParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the post users params
func (o *PostUsersParams) SetUser(user *models.MainCreateUserRequest) {
	o.User = user
}
